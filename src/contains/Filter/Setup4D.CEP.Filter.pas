...
begin
  ...
  FFilterIBGE.Key.Value(EmptySTR);
  FFilterIBGE.Address.City(EmptyStr);
  FFilterIBGE.Address.StateAbbreviated(EmptyStr);
...
begin
  ...
  FFilterZipCode.Key.Value(EmptyStr);
  FFilterZipCode.Address.Types(EmptyStr);
  FFilterZipCode.Address.Street(EmptyStr);
  FFilterZipCode.Address.City(EmptyStr);
  FFilterZipCode.Address.StateAbbreviated(EmptyStr);
  FFilterZipCode.Address.District(EmptyStr);
end;
